...
def index_documents(query):
    return DOCUMENT_VECTOR_DB.add_documents(query)
...
st.title(" Saber AI Doc Scrapper")
...
if uploaded_pdf:
    ...
    st.success(" Document processed successfully! Ask questions right away.")
    ...
    if user_input:
        ...
        with st.spinner("Analyzing document..."):
            relevant_docs = find_relevant_documents(user_input)
